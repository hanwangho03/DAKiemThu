...
namespace WebDoDienTu.Migrations
{
    ...
    [Migration("20241109182235_UpdatePostModel")]
            ...
            modelBuilder.Entity("WebDoDienTu.Models.Promotion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 11, 20, 1, 22, 32, 535, DateTimeKind.Local).AddTicks(7965),
                            IsActive = true,
                            IsPercentage = false,
                            MinimumOrderAmount = 0m,
                            StartDate = new DateTime(2024, 10, 31, 1, 22, 32, 535, DateTimeKind.Local).AddTicks(7947)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            EndDate = new DateTime(2024, 11, 25, 1, 22, 32, 535, DateTimeKind.Local).AddTicks(7968),
                            IsActive = true,
                            IsPercentage = true,
                            MinimumOrderAmount = 100m,
                            StartDate = new DateTime(2024, 11, 5, 1, 22, 32, 535, DateTimeKind.Local).AddTicks(7967)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            DiscountAmount = 50m,
                            DiscountPercentage = 0m,
                            EndDate = new DateTime(2024, 11, 30, 1, 22, 32, 535, DateTimeKind.Local).AddTicks(7970),
                            IsActive = true,
                            IsPercentage = false,
                            MinimumOrderAmount = 200m,
                            StartDate = new DateTime(2024, 11, 9, 1, 22, 32, 535, DateTimeKind.Local).AddTicks(7969)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            EndDate = new DateTime(2024, 12, 10, 1, 22, 32, 535, DateTimeKind.Local).AddTicks(7972),
                            IsActive = true,
                            IsPercentage = true,
                            MinimumOrderAmount = 0m,
                            StartDate = new DateTime(2024, 10, 11, 1, 22, 32, 535, DateTimeKind.Local).AddTicks(7971)
                        });
                });
